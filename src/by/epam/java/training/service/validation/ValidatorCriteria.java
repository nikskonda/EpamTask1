...
public class ValidatorCriteria<E> {
    ...
    public static <E> boolean isValidCriteria(Criteria<E> criteria) {
        switch (criteria.getGroupSearchName()) {
            case Oven:
                return isValidOven(criteria);
            case Laptop:
                return isValidLaptop(criteria);
            case TabletPC:    
                return isValidTabletPC(criteria);
            case Refrigerator:
                return isValidRefrigerator(criteria);
            case Speakers:
                return isValidSpeakers(criteria);
            case VacuumCleaner:
                return isValidVacuumCleaner(criteria);
            case Newspaper:
                return isValidNewspaper(criteria);
            case TextBook:
                return isValidTextBook(criteria);
            default:
                break;
        }
        return true;
